...
// Define your `board` object here!
 var board = {  } 
 board.cells = [
   {hidden:true, row: 0, col: 0, isMine: true}, {hidden:true, row: 0, col:1, isMine: true}, {hidden:true, row: 0, col:2, isMine: false},  {hidden:true, row: 0, col:3, isMine: true},
   ...
   {hidden:true, row: 2, col: 0, isMine: true}, {hidden:true, row: 2, col:1, isMine: true}, {hidden:true, row: 2, col:2, isMine: true},  {hidden:true, row: 2, col:3, isMine: false},
